    ...
    <div data-widget="double-cta" class="x_panel">
        <div class="x_title content handle">
            <h2>
                ...
                <span class="heading">Double CTA Block</span>
        ...
        <div class="content">
            ...
            <div class="item form-group ">
                <label class="control-label col-md-2 col-sm-2 col-xs-12">Title</label>
                <div class="col-md8 col-sm-8 col-xs-12">
                    {!! Form::text( null, null, [ 'data-name' => 'title-2', 'class' => 'form-control' ] ) !!}
                </div>
            </div>
            <div class="item form-group ">
                <label class="control-label col-md-2 col-sm-2 col-xs-12">Content</label>
                <div class="col-md8 col-sm-8 col-xs-12">
                    {!! Form::textarea( null, null, [ 'data-name' => 'content-2', 'class' => 'form-control wysiwyg' ] ) !!}
                </div>
            </div>
            <div class="item form-group ">
                <label class="control-label col-md-2 col-sm-2 col-xs-12">Button Text</label>
                <div class="col-md8 col-sm-8 col-xs-12">
                    {!! Form::text( null, null, [ 'data-name' => 'button-text-2', 'class' => 'form-control' ] ) !!}
                </div>
            </div>
            <div class="item form-group ">
                <label class="control-label col-md-2 col-sm-2 col-xs-12">Button URL</label>
                <div class="col-md8 col-sm-8 col-xs-12">
                    {!! Form::text( null, null, [ 'data-name' => 'button-url-2', 'class' => 'form-control' ] ) !!}
                </div>
            </div>
    ...
    <div data-widget="double-cta" class="x_panel">
        ...
        <div class="content">
            ...
            @include('auth.global.templates.forms.singleField', [
                'label' => 'Background Image',
                'fieldName' => null,
                'fieldValue' => isset( $data['image-2']) ? $data['image-2'] : '',
                'fieldType' => 'text',
                'fieldData' => null,
                'fieldValidation' => [
                    'data-for' => 'media-attachment',
            ...
            <div class="item form-group ">
                <label class="control-label col-md-2 col-sm-2 col-xs-12">Title</label>
                <div class="col-md8 col-sm-8 col-xs-12">
                    {!! Form::text( null, isset( $data['title-2']) ? $data['title-2'] : '', [ 'data-name' => 'title-2', 'class' => 'form-control' ] ) !!}
                </div>
            </div>
            <div class="item form-group ">
                <label class="control-label col-md-2 col-sm-2 col-xs-12">Content</label>
                <div class="col-md8 col-sm-8 col-xs-12">
                    {!! Form::textarea( null, isset( $data['content-2']) ? $data['content-2'] : '', [ 'data-name' => 'content-2', 'class' => 'form-control wysiwyg'  ] ) !!}
                </div>
            </div>
            <div class="item form-group ">
                <label class="control-label col-md-2 col-sm-2 col-xs-12">Button Text</label>
                <div class="col-md8 col-sm-8 col-xs-12">
                    {!! Form::text( null, isset( $data['button-text-2'] ) ? $data['button-text-2'] : '', [ 'data-name' => 'button-text-2', 'class' => 'form-control' ] ) !!}
                </div>
            </div>
            <div class="item form-group ">
                <label class="control-label col-md-2 col-sm-2 col-xs-12">Button URL</label>
                <div class="col-md8 col-sm-8 col-xs-12">
                    {!! Form::text( null, isset( $data['button-url-2'] ) ? $data['button-url-2'] : '', [ 'data-name' => 'button-url-2', 'class' => 'form-control' ] ) !!}
                </div>
            </div>
