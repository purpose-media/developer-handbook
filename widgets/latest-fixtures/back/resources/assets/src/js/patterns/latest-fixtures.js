...
(function () {
    ...
    $.fn.latestFixturesWidget = function( options )
    {

        var LatestFixtures = function( elm )
        {
        ...
        return $(this).each( function() {
            $(this).data( 'latest-fixtures', new LatestFixtures( $(this) ) );
        });
...
$(function() {
    ...
    $('[data-widget="latest-fixtures"]').latestFixturesWidget();
