@if( ! isset( $model_region ) )
    <div data-widget="left-content-right-advert" class="x_panel">
        <div class="x_title content handle">
            <h2>
                <span  class="pull-left"><i class="fa fa-arrows"></i></span>
                <span class="heading">Left Content Right Advert Block</span>
                <a data-for="delete-region-model" href="#" class="btn btn-danger btn-sm pull-right"><i class="fa fa-trash"></i></a>
            </h2>
            <div class="clearfix"></div>
        </div>
        <div class="content">
            <p>The content will be pulled through from the "general" tab</p>
            <div class="item form-group ">
                <label class="control-label col-md-2 col-sm-2 col-xs-12">Advert</label>
                <div class="col-md8 col-sm-8 col-xs-12">
                    {!! Form::select( null, $adverts, null, [ 'data-name' => 'advert', 'class' => 'form-control' ] ) !!}
                </div>
            </div>
    ...
    <div data-widget="left-content-right-advert" class="x_panel">
        ...
        <div class="content">
            ...
            <div class="item form-group ">
                <label class="control-label col-md-2 col-sm-2 col-xs-12">Advert</label>
                <div class="col-md8 col-sm-8 col-xs-12">
                    {!! Form::select( null, $adverts, isset( $data['advert'] ) ? $data['advert'] : '', [ 'data-name' => 'advert', 'class' => 'form-control' ] ) !!}
                </div>
            </div>
