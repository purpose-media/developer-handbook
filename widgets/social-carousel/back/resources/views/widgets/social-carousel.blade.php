@if( ! isset( $model_region ) )
    <div data-widget="social-carousel" class="x_panel">
        <div class="x_title content handle">
            <h2>
                <span  class="pull-left"><i class="fa fa-arrows"></i></span>
                <span class="heading">Social Carousel Block</span>
        ...
        <div class="content">
            <div class="item form-group ">
                <label class="control-label col-md-2 col-sm-2 col-xs-12">Amount of items to display</label>
